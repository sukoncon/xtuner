...
CACHE_DIR = "/mnt/shared-storage-user/suzhongling/xtuner_11_27/xtuner_cache2"
# 改成你的 xtuner 路径
WORK_DIR = "/mnt/shared-storage-user/suzhongling/xtuner_11_27/work_dirs/qwen30_ep8_nccl_1_node"
...
dataset_config = [
    {
        "dataset": DatasetConfig(
            name="data1",
            anno_path="/mnt/shared-storage-user/caoweihan/data/open-thoughts-one/",
            sample_ratio=1.0,
            cache_dir=CACHE_DIR,
        ),
