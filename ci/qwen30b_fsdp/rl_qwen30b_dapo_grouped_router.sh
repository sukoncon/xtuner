...
# export PYTHONPATH=$PYTHONPATH:/mnt/shared-storage-user/suzhongling/grouped_gemm/local/lib/python3.12/dist-packages/grouped_gemm-1.1.4-py3.12-linux-x86_64.egg
...
torchrun --nproc-per-node=8  \
    ...
    --nnodes=${NODE_COUNT} \
    --node_rank=${NODE_RANK} \
    xtuner/v1/train/cli/sft_ib.py --config ci/qwen30b_fsdp/agrs_acc_test.py