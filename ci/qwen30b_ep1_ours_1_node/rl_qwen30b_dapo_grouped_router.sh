...
cp ci/_fsdp_collectives_custom_comm.py /usr/local/lib/python3.12/dist-packages/torch/distributed/fsdp/_fully_shard/_fsdp_collectives.py
# cp ci/_fsdp_collectives.py /usr/local/lib/python3.12/dist-packages/torch/distributed/fsdp/_fully_shard/_fsdp_collectives.py
...
torchrun --nproc-per-node=8  \
    --master_port=6001 \
    xtuner/v1/train/cli/sft_ib.py --config /mnt/shared-storage-user/suzhongling/xtuner_11_27/ci/qwen30b_ep1_ours_1_node/agrs_acc_test.py
